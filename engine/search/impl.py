"""Alpha-beta search implementation inside engine.search package.

Contains alpha_beta, quiescence, PV builder and search state classes.
"""
...
from ..utils.constants import MATE_SCORE
